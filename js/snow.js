    ...
    function () {
        ...
        function g(a) {
            if (typeof window.onload != "function") window.onload = a;
                ...
                var b = window.onload; window.onload = function () { b(); a() }
            }
        }
        ...
        function h() {
            ...
            for (type in { Top: "", Left: "" }) {
                ...
                if (typeof window["page" + b + "Offset"] != "undefined")
                    ...
                    b = document.documentElement.clientHeight ? document.documentElement : document.body; a[type.toLowerCase()] = b["scroll" + type]
                }
            } return a
        }
        function l() {
            var a = document.body, b;
            if (window.innerHeight) b = window.innerHeight; else if (a.parentElement.clientHeight) b = a.parentElement.clientHeight; else if (a && a.clientHeight) b = a.clientHeight; return b
            ...
            createEl: function (a, b) {
                ...
                this.el.setAttribute("src", "src/T--USTC--snow0.gif");
                this.el.style.position = "absolute"; this.el.style.display = "block"; this.el.style.zIndex = "99999"; this.parent.appendChild(this.el)
